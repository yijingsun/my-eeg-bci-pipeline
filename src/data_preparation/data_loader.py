...
class BCIDataLoader:
    def __init__(self, eog_channels=None, set_montage=True, channel_renaming=None, montage_name=None):
        self.eog_channels = eog_channels if eog_channels is not None else ["EOG-left", "EOG-central", "EOG-right"]
